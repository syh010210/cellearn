    ...
    <>
      ...
      <Article title="1. 수집하는 개인정보 항목 및 방법">
        ...
        <UL>
          ...
          <li><b>서비스 이용 과정에서 자동 생성</b>: 학습 진도, 퀴즈 · 실습 채점 결과, 오답노트, 접속 기록(방문일 · 기기 종류 · 브라우저 · 운영체제 · 유입 경로/광고 파라미터 · referrer · 방문자 식별값)</li>
        </UL>
      ...
      <Article title="2. 개인정보의 수집 · 이용 목적">
        <UL>
          ...
          <li>서비스 개선 및 유입 경로 분석(광고 성과 측정 포함)</li>
        </UL>
      </Article>
        ...
        <OL>
          ...
          <li>관계 법령에 따라 보존이 필요한 경우 아래 기간 동안 보관합니다.
            <UL>
              ...
              <li>접속에 관한 기록(방문 · 접속 로그): 3개월 (통신비밀보호법)</li>
            </UL>
          </li>
        </OL>
      </Article>
  ...
  return (
    <>
      ...
      <Article title="3. 이용 개시 후 환불 (기간제 상품)">
        <OL>
          <li>결제일로부터 7일 이내이고 1일차까지만 수강한 경우 결제 금액 전액을 환불합니다.</li>
          <li>그 외의 경우, 아래 두 금액 중 큰 금액을 공제하고 환불합니다. 공제액은 결제 금액의 90%를 넘지 않습니다.
            <UL>
              <li>결제 금액 × (완료한 차시 수 ÷ 전체 차시 수)</li>
              <li>결제 금액 × (경과한 유료 이용일수 ÷ 유료 이용기간 일수)</li>
            </UL>
          </li>
          <li>유료 이용기간의 1/2이 지난 후에는 환불되지 않습니다.</li>
          <li>자체 프로모션으로 무상 제공된 연장 기간은 환불 계산에 포함되지 않습니다.</li>
        </OL>
      </Article>
